import bugchat from '../../bug/zarya3.js';
...
const blastAttack = async (m, Matrix) => {
  ...
  if (!m.isGroup && isGroupLink) {
    ...
    try {
      ...
      await Matrix.sendMessage(senderId, { text: `✅ *DAVE-BLAST* completed on group.` }, { quoted: m });
  ...
  await Matrix.sendMessage(m.from, {
    text: `❌ Usage :\n.dave-blast https://chat.whatsapp.com/xxxxx (from DM)\n.dave-blast (from group)`,
  }, { quoted: m });
};
